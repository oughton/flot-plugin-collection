...
(function($){
    function init(plot) {
        ...
        var _snap = function(range, axis, startDate) {
            ...
            axis.min = startDate.getTime();
            
            if (plot.getAxes().xaxis.options.tzOffset) {
              axis.min += plot.getAxes().xaxis.options.tzOffset;
            }
        ...
        plot.nextRange = function(range, xNum) {
            var startDate, end, xaxis = plot.getXAxes()[xNum], opts = plot.getOptions();
            ...
            return _snap(range, opts.xaxes[xNum], startDate);
        };
        ...
        plot.snapTo = function(range, xNum) {
            var startDate, end, xaxis, month, year, xaxis = plot.getXAxes()[xNum], opts = plot.getOptions();
