...
(function ($) {
    ...
    function init(plot) {
        ...
        plot.moveTo = function(args) {
            $.each(plot.getUsedAxes(), function (i, axis) {
                var opts = axis.options;

                if (axis.direction == "x" && args.xaxis) {
                    if (args.n && args.n != axis.n) return;
                    opts.min = args.xaxis.min;
                    opts.max = args.xaxis.max;
                } else if (axis.direction == "y" && args.yaxis) {
                    if (args.n && args.n != axis.n) return;
                    opts.min = args.yaxis.min;
                    opts.max = args.yaxis.max;
                }           
            });
